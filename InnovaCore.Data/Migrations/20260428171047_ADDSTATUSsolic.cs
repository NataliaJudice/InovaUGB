...
{
    /// <inheritdoc />
    public partial class ADDSTATUSsolic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 28, 14, 10, 47, 125, DateTimeKind.Local).AddTicks(835), "Enviada", true },
                    { 2, new DateTime(2026, 4, 28, 14, 10, 47, 125, DateTimeKind.Local).AddTicks(854), "Aprovada", true },
                    { 3, new DateTime(2026, 4, 28, 14, 10, 47, 125, DateTimeKind.Local).AddTicks(856), "Inviabilizada", true }
                });
        }
